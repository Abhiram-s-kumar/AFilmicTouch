...
import { FaCode, FaDesktop, FaMobile, FaDatabase, FaCloud, FaRegClock, FaRegUser, FaStar, FaPlay, FaArrowRight, FaQuoteLeft, FaGlobe, FaTools, FaRocket } from 'react-icons/fa';
...
const WebDevelopment = () => {
  ...
  const galleryImages = [Blue1, Blue2, Blue3, Blue4, Blue5, Blue6, Blue7, Blue8, Blue9,web];
  ...
  return (
    <>
      ...
      <div style={{ fontFamily: 'Poppins, sans-serif', background: '#fff', color: '#000' }}>
        ...
        {/* Hero Section */}
        <section style={{
          background: `linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.6) 100%), url(${web})`,
          ...
          {/* Removed floating code elements animation */}
          <Container>
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <div style={{ textAlign: 'center', color: '#fff' }}>
                          <h5 style={{ fontWeight: 600, marginBottom: 10 }}>Project {idx + 1}</h5>
                          <p style={{ fontSize: '0.9rem', opacity: 0.9 }}>View Details</p>
                        </div>
                      </div>
                    </div>
                  </Fade>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          ...
                          <div style={{ display: 'flex', gap: 2 }}>
                            {[...Array(testimonial.rating)].map((_, i) => (
                              <FaStar key={i} style={{ color: '#007bff', fontSize: '0.9rem' }} />
                            ))}
                          </div>
                        </div>
                      </Card.Body>
              ...
              <Col lg={8} className="text-center">
                <Fade direction="up" triggerOnce>
                  ...
                  <div style={{ display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    >
                      Get Free Quote <FaArrowRight style={{ marginLeft: 8 }} />
                    </Button>
